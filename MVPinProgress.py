...
# the most common job titles for each trait
ext_titles = ['Systemutvecklare/Programmerare']
agr_titles = ['Helpdesktekniker/Supporttekniker']
con_titles = ['Helpdesktekniker/Supporttekniker']
emo_titles = ['Helpdesktekniker/Supporttekniker']
int_titles = ['Systemutvecklare/Programmerare']
...
trait = nearest_job_titles.mode()[0]
