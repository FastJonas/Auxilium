...
if ext > agr and ext > con and ext > emo and ext > inte:
    trait = "ext"
elif agr > con and agr > emo and agr > inte:
    trait = "agr"
elif con > emo and con > inte:
    trait = "con"
elif emo > inte:
    trait = "emo"
else:
...
trait_df.to_excel('kopplade_traits_keywords.xlsx', index=False)
...
sentences = df['Trait Words'].tolist()
